 ...
 *
 *  A graph_creator generator.
 *
 *  For many more graph_creator generators, see
...
public class GraphGenerator {
    ...
    /**
     * Returns a random simple graph_creator containing {@code V} vertices and {@code E} edges.
     * @param V the number of vertices
     * @param E the number of vertices
     * @return a random simple graph_creator on {@code V} vertices, containing a total
     *     of {@code E} edges
     * @throws IllegalArgumentException if no such simple graph_creator exists
     */
    ...
    /**
     * Returns a random simple graph_creator on {@code V} vertices, with an
     * edge between any two vertices with probability {@code p}. This is sometimes
     * referred to as the Erdos-Renyi random graph_creator model.
     * @param V the number of vertices
     * @param p the probability of choosing an edge
     * @return a random simple graph_creator on {@code V} vertices, with an edge between
    ...
    /**
     * Returns the complete graph_creator on {@code V} vertices.
     * @param V the number of vertices
     * @return the complete graph_creator on {@code V} vertices
     */
    ...
    /**
     * Returns a complete bipartite graph_creator on {@code V1} and {@code V2} vertices.
     * @param V1 the number of vertices in one partition
     * @param V2 the number of vertices in the other partition
     * @return a complete bipartite graph_creator on {@code V1} and {@code V2} vertices
     * @throws IllegalArgumentException if probability is not between 0 and 1
     */
    ...
    /**
     * Returns a random simple bipartite graph_creator on {@code V1} and {@code V2} vertices
     * with {@code E} edges.
     * @param V1 the number of vertices in one partition
     * @param V2 the number of vertices in the other partition
     * @param E the number of edges
     * @return a random simple bipartite graph_creator on {@code V1} and {@code V2} vertices,
     *    containing a total of {@code E} edges
     * @throws IllegalArgumentException if no such simple bipartite graph_creator exists
     */
     ...
     * @param V1 the number of vertices in one partition
     * @param V2 the number of vertices in the other partition
     * @param p the probability that the graph_creator contains an edge with one endpoint in either side
     * @return a random simple bipartite graph_creator on {@code V1} and {@code V2} vertices,
     *    containing each possible edge with probability {@code p}
     * @throws IllegalArgumentException if probability is not between 0 and 1
     */
    ...
    /**
     * Returns a path graph_creator on {@code V} vertices.
     * @param V the number of vertices in the path
     * @return a path graph_creator on {@code V} vertices
     */
    ...
    /**
     * Returns a complete binary tree graph_creator on {@code V} vertices.
     * @param V the number of vertices in the binary tree
     * @return a complete binary tree graph_creator on {@code V} vertices
     */
    ...
    /**
     * Returns a cycle graph_creator on {@code V} vertices.
     * @param V the number of vertices in the cycle
     * @return a cycle graph_creator on {@code V} vertices
     */
    ...
    /**
     * Returns an Eulerian cycle graph_creator on {@code V} vertices.
     *
     * @param  V the number of vertices in the cycle
     * @param  E the number of edges in the cycle
     * @return a graph_creator that is an Eulerian cycle on {@code V} vertices
     *         and {@code E} edges
    ...
    /**
     * Returns an Eulerian path graph_creator on {@code V} vertices.
     *
     * @param  V the number of vertices in the path
     * @param  E the number of edges in the path
     * @return a graph_creator that is an Eulerian path on {@code V} vertices
     *         and {@code E} edges
     * @throws IllegalArgumentException if either {@code V <= 0} or {@code E < 0}
     */
    ...
    /**
     * Returns a wheel graph_creator on {@code V} vertices.
     * @param V the number of vertices in the wheel
     * @return a wheel graph_creator on {@code V} vertices: a single vertex connected to
    ...
    /**
     * Returns a star graph_creator on {@code V} vertices.
     * @param V the number of vertices in the star
     * @return a star graph_creator on {@code V} vertices: a single vertex connected to
     *     every other vertex
     */
    ...
    /**
     * Returns a uniformly random {@code k}-regular graph_creator on {@code V} vertices
     * (not necessarily simple). The graph_creator is simple with probability only about e^(-k^2/4),
     * which is tiny when k = 14.
     *
     * @param V the number of vertices in the graph_creator
     * @param k degree of each vertex
     * @return a uniformly random {@code k}-regular graph_creator on {@code V} vertices.
     */
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("complete graph_creator");
