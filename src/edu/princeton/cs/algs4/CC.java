 ...
 *  determining the connected components in an undirected graph_creator.
...
public class CC {
    ...
    /**
     * Computes the connected components of the undirected graph_creator {@code G}.
     *
    ...
    /**
     * Computes the connected components of the edge-weighted graph_creator {@code G}.
     *
    ...
    /**
     * Returns the number of connected components in the graph_creator {@code G}.
     *
     * @return the number of connected components in the graph_creator {@code G}
     */
    public int count() {
        return count;
    }
