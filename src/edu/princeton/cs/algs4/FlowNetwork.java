...
public class FlowNetwork {
    ...
    /**
     * Returns the number of vertices in the edge-weighted graph_creator.
     * @return the number of vertices in the edge-weighted graph_creator
     */
    public int V() {
        return V;
    }
    ...
    /**
     * Returns the number of edges in the edge-weighted graph_creator.
     * @return the number of edges in the edge-weighted graph_creator
     */
    public int E() {
        return E;
    }
