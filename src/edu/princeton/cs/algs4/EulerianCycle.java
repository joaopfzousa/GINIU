 ...
 *
 *  Find an Eulerian cycle in a graph_creator, if one exists.
 *
 *  Runs in O(E + V) time.
 *
 ...
 *  for finding an Eulerian cycle or path in a graph_creator.
...
public class EulerianCycle {
    ...
    /**
     * Computes an Eulerian cycle in the specified graph_creator, if one exists.
     * 
    ...
    /**
     * Returns true if the graph_creator has an Eulerian cycle.
     * 
     * @return {@code true} if the graph_creator has an Eulerian cycle;
    ...
    // Determines whether a graph_creator has an Eulerian cycle using necessary
    ...
    public static void main(String[] args) {
        ...
        unitTest(G3, "empty graph_creator");
        ...
        unitTest(G6, "simple graph_creator");
    }
}
