 ...
 * <em>global minimum cut</em> in an edge-weighted graph_creator where the edge
 * weights are nonnegative. A <em>cut</em> is a partition of the set
 * of vertices of a graph_creator into two nonempty subsets. An edge that has one
 ...
 * graph_creator), where <em>V</em> is the number of vertices and <em>E</em> is the
...
public class GlobalMincut {
     ...
     * cut-of-the-phase is a <em>minimum s-t-cut</em> in the current graph_creator,
    ...
    /**
     * Computes a minimum cut of an edge-weighted graph_creator.
     * 
     * @param G the edge-weighted graph_creator
    ...
    /**
     * Validates the edge-weighted graph_creator.
     * 
     * @param G the edge-weighted graph_creator
     * @throws IllegalArgumentException if the number of vertices of {@code G}
    ...
    /**
     * Makes a cut for the current edge-weighted graph_creator by partitioning its set
    ...
    /**
     * Computes a minimum cut of the edge-weighted graph_creator. Precisely, it computes
     ...
     * in the current graph_creator, where {@code s} and {@code t} are the two vertices
     ...
     * the given edge-weighted graph_creator.
     * 
     * @param G the edge-weighted graph_creator
     * @param s the vertex {@code s}
     * @param t the vertex {@code t}
     * @return a new edge-weighted graph_creator for which the edges incidents on the
