 ...
 *  @author Kevin Wayne
 */
public class EdgeWeightedDigraph_Project implements Serializable {
     ...
     */
    public EdgeWeightedDigraph_Project(int V) {
     ...
     */
    public EdgeWeightedDigraph_Project(int V, int E) {
        this(V);
     ...
     */
    public EdgeWeightedDigraph_Project(In in) {
        this(in.readInt());
        int E = in.readInt();
     ...
     */
    public EdgeWeightedDigraph_Project(EdgeWeightedDigraph_Project G) {
        this(G.V());
        this.E = G.E();
        for (int v = 0; v < G.V(); v++)
    ...
    public static void main(String[] args) {
        In in = new In(args[0]);
        EdgeWeightedDigraph_Project G = new EdgeWeightedDigraph_Project(in);
        StdOut.println(G);
    }
